...
if running then	
	m = Map("vlmcsd", translate("KMS config"), translate("<b><font color=green>KMS running</font></b>"))
else
	m = Map("vlmcsd", translate("KMS config"), translate("<b><font color=red>KMS stopped</font></b>"))
end
